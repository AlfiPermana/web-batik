<x-layouts.landing title="Home - Batik Giri Alam Gumelem Wetan">
    <!-- Hero Section -->
    <section class="relative py-12 md:py-20 bg-[#f5f1e8]">
        <!-- Background Image -->
        <div class="absolute inset-0 overflow-hidden">
            <img src="{{ asset('assets/herobgbatik.png') }}" alt="Background Batik" class="w-full h-full object-cover">
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="order-2 lg:order-1">
                    <div class="rounded-2xl overflow-hidden shadow-lg">
                        <img src="{{ asset('assets/warisanbudaya.png') }}" alt="Warisan Budaya Batik Giri Alam"
