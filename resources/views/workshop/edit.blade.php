<x-layouts.app :title="__('Edit Workshop')">
    <div class="flex h-full w-full flex-1 flex-col gap-4">
        <div class="mb-2">
            <flux:heading size="xl">Edit Workshop</flux:heading>
            <flux:subheading>Update workshop information</flux:subheading>
        </div>

        <div class="rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 max-w-2xl">
            <form action="{{ route('workshop.update', $workshop) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    <flux:field>
                        ...
                        <input id="description" type="hidden" name="description" value="{{ old('description', $workshop->description) }}">
