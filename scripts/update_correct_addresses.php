...
$address1->city = 'Banyumas'; // City name for 591
$address1->city_id = 591;
$address1->district = 'Jatilawang';
$address1->district_id = 6138; // District ID untuk Jatilawang
$address1->subdistrict = '';
$address1->subdistrict_id = null;
...
$address2->city = 'Banyumas'; // City name for 591  
$address2->city_id = 591;
$address2->district = 'Ajibarang';
$address2->district_id = 6135; // District ID untuk Ajibarang
$address2->subdistrict = '';
$address2->subdistrict_id = null;
...
foreach ($addresses as $addr) {
    ...
    echo "  Nama: {$addr->full_name}\n";
    echo "  District: {$addr->district} (ID: {$addr->district_id})\n";
    echo "  City: {$addr->city} (ID: {$addr->city_id})\n";
    echo "  Default: " . ($addr->is_default ? 'Yes' : 'No') . "\n";
    echo "  ---\n";
}

echo "\nOrigin District ID: " . config('services.raja_ongkir.origin_district_id') . "\n";
echo "Seharusnya sekarang bisa dapat banyak opsi pengiriman!\n";
