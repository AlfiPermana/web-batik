...
<head>
    ...
    <title><?php echo e($title ?? 'Batik Giri Alam Gumelem Wetan'); ?></title>
...
<body class="font-sans antialiased">
        ...
        <nav class="fixed top-0 left-0 right-0 bg-white shadow-sm z-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex items-center">
                        <a href="<?php echo e(route('landing.home')); ?>" class="flex items-center">
                            <img src="<?php echo e(asset('assets/logo.png')); ?>" alt="Batik Giri Alam"
                    ...
                    <div class="hidden md:flex items-center space-x-8" style="font-family: 'Poppins', sans-serif;">
                        <a href="<?php echo e(route('landing.home')); ?>"
                            class="text-[#8B4513] hover:text-[#6B3410] font-medium transition-colors <?php echo e(request()->routeIs('landing.home') ? 'font-bold' : ''); ?>">
                            Beranda
                        </a>
                        <a href="<?php echo e(route('landing.about')); ?>"
                            class="text-[#8B4513] hover:text-[#6B3410] font-medium transition-colors <?php echo e(request()->routeIs('landing.about') ? 'font-bold' : ''); ?>">
                            Sejarah
                        </a>
                        <a href="<?php echo e(route('landing.shop')); ?>"
                            class="text-[#8B4513] hover:text-[#6B3410] font-medium transition-colors <?php echo e(request()->routeIs('landing.shop') ? 'font-bold' : ''); ?>">
                            Produk
                        </a>
                        <a href="<?php echo e(route('landing.workshop')); ?>"
                            class="text-[#8B4513] hover:text-[#6B3410] font-medium transition-colors <?php echo e(request()->routeIs('landing.workshop') ? 'font-bold' : ''); ?>">
                            Workshop
                        </a>
                        <a href="<?php echo e(route('landing.contact')); ?>"
                            class="text-[#8B4513] hover:text-[#6B3410] font-medium transition-colors <?php echo e(request()->routeIs('landing.contact') ? 'font-bold' : ''); ?>">
                            Kontak
                        </a>
                    </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            ...
                            <a href="<?php echo e(route('cart.index')); ?>"
                                ...
                                <span
                                    ...
                                    id="cart-badge">
                                    <?php echo e(Auth::user()->cart ? Auth::user()->cart->items->count() : 0); ?>

                                </span>
                            </a>
                            <!-- Dashboard Button -->
                            <a href="<?php echo e(Auth::user()->role === 'admin' ? route('admin.dashboard') : route('customer.dashboard')); ?>"
            ...
            <div id="mobile-menu" class="hidden md:hidden border-t border-gray-200"
                ...
                <div class="px-2 pt-2 pb-3 space-y-1">
                    <a href="<?php echo e(route('landing.home')); ?>"
                        class="block px-3 py-2 text-[#8B4513] hover:bg-[#f5f1e8] rounded-md <?php echo e(request()->routeIs('landing.home') ? 'bg-[#f5f1e8] font-bold' : ''); ?>">
                        Beranda
                    </a>
                    <a href="<?php echo e(route('landing.about')); ?>"
                        class="block px-3 py-2 text-[#8B4513] hover:bg-[#f5f1e8] rounded-md <?php echo e(request()->routeIs('landing.about') ? 'bg-[#f5f1e8] font-bold' : ''); ?>">
                        Sejarah
                    </a>
                    <a href="<?php echo e(route('landing.shop')); ?>"
                        class="block px-3 py-2 text-[#8B4513] hover:bg-[#f5f1e8] rounded-md <?php echo e(request()->routeIs('landing.shop') ? 'bg-[#f5f1e8] font-bold' : ''); ?>">
                        Produk
                    </a>
                    <a href="<?php echo e(route('landing.workshop')); ?>"
                        class="block px-3 py-2 text-[#8B4513] hover:bg-[#f5f1e8] rounded-md <?php echo e(request()->routeIs('landing.workshop') ? 'bg-[#f5f1e8] font-bold' : ''); ?>">
                        Workshop
                    </a>
                    <a href="<?php echo e(route('landing.contact')); ?>"
                        class="block px-3 py-2 text-[#8B4513] hover:bg-[#f5f1e8] rounded-md <?php echo e(request()->routeIs('landing.contact') ? 'bg-[#f5f1e8] font-bold' : ''); ?>">
                        Kontak
                    </a>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-4">
                            <img src="<?php echo e(asset('assets/logo.png')); ?>" alt="Batik Giri Alam" class="h-10">
                        </div>
                ...
                <div class="border-t border-gray-300 pt-6 text-center">
                    <p class="text-sm" style="font-family: 'Poppins', sans-serif;">
                        &copy; <?php echo e(date('Y')); ?> Batikgirialam. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
    ...
    <script>
        ...
        function openWhatsApp() {
            const phoneNumber = '6285155227923';
...
<?php /**PATH C:\web-batik\resources\views/components/layouts/landing.blade.php ENDPATH**/ ?>